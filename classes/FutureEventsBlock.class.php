...
class FutureEventsBlock
{
  ...
  {
    $url = 'http://' . $_SERVER['HTTP_HOST'] . '/index.php?display=FutureEventDetails%26id=' . $this->ID;

    $shareurl = 'mailto:?subject=Thought%20you%20would%20like%20to%20know&body=Check%20out%20this%20event.%0A%0AIt is named: ' . 
                str_replace('=','',str_replace('&','and',str_replace('?','',$this->Name))) . '%0A%0ALocation: ' . $this->Location . '%0A%0ADate: ' . 
                $this->Date . '%0A%0AFrom: ' . $this->Start . '%20-%20' . $this->End . '%0A%0ARSVP here: ' . $url;
        ...
        <div class="caption">
          ...
          <table role="presentation" class="table">
            ...
            <tr>
              ...
              <td class="text-center">
                <a onclick="sendEmail()" class="btn btn-success" role="button">Share</a>
              </td>
            </tr>
